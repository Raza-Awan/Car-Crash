...
public class Battle_CarBoost : MonoBehaviour
{
    ...
    private Battle_SelectedCarSpawner selected_Car_Spawner;
    ...
    void Start()
    {
        selected_Car_Spawner = GetComponent<Battle_SelectedCarSpawner>();
