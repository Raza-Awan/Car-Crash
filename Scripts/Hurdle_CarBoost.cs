...
public class Hurdle_CarBoost : MonoBehaviour
{
    ...
    private Hurdle_SelectedCarSpawner selected_Car_Spawner;
    ...
    void Start()
    {
        selected_Car_Spawner = GetComponent<Hurdle_SelectedCarSpawner>();
